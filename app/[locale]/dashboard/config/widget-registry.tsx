...
import { PerformanceAreaChart } from '@/components/widgets-ported/AdvancedCharts'
import { StatisticsWidget as PremiumStats, AccountSummary, RiskAlertWidget } from '@/components/widgets-ported/AdvancedStats'
import { TradeTableReview as PremiumTradeTableReview, PropFirmOverview, PremiumChatWidget } from '@/components/widgets-ported/FunctionalWidgets'
import { ExecutionScore, PsychologyMonitor } from '@/components/widgets-ported/ExecutionScore'
import { CalendarWidget as PremiumCalendar, QuickJournalWidget } from '@/components/widgets-ported/CalendarJournal'
import { MarketSentimentWidget, DailyDrawdown } from '@/components/widgets-ported/Monitoring'
...
export const WIDGET_REGISTRY: Record<WidgetType, WidgetConfig> = {
  ...
  premiumEquityChart: {
    type: 'premiumEquityChart',
    defaultSize: 'medium',
    allowedSizes: ['medium', 'large'],
    category: 'charts',
    getComponent: () => <PerformanceAreaChart data={[]} />,
    getPreview: () => <PerformanceAreaChart data={[]} />
  },
  premiumStats: {
    type: 'premiumStats',
    defaultSize: 'medium',
    allowedSizes: ['medium'],
    category: 'statistics',
    getComponent: () => <PremiumStats />,
    getPreview: () => <PremiumStats />
  },
  premiumAccountSummary: {
    type: 'premiumAccountSummary',
    defaultSize: 'medium',
    allowedSizes: ['medium'],
    category: 'statistics',
    getComponent: () => <AccountSummary />,
    getPreview: () => <AccountSummary />
  },
  premiumRiskAlert: {
    type: 'premiumRiskAlert',
    defaultSize: 'medium',
    allowedSizes: ['medium'],
    category: 'statistics',
    getComponent: () => <RiskAlertWidget />,
    getPreview: () => <RiskAlertWidget />
  },
  premiumTradeReview: {
    type: 'premiumTradeReview',
    defaultSize: 'extra-large',
    allowedSizes: ['extra-large'],
    category: 'tables',
    requiresFullWidth: true,
    getComponent: () => <PremiumTradeTableReview />,
    getPreview: () => <PremiumTradeTableReview />
  },
  premiumPropFirm: {
    type: 'premiumPropFirm',
    defaultSize: 'medium',
    allowedSizes: ['medium', 'large'],
    category: 'tables',
    getComponent: () => <PropFirmOverview />,
    getPreview: () => <PropFirmOverview />
  },
  premiumChat: {
    type: 'premiumChat',
    defaultSize: 'large',
    allowedSizes: ['large'],
    category: 'other',
    getComponent: () => <PremiumChatWidget />,
    getPreview: () => <PremiumChatWidget />
  },
  premiumExecutionScore: {
    type: 'premiumExecutionScore',
    defaultSize: 'medium',
    allowedSizes: ['medium'],
    category: 'statistics',
    getComponent: () => <ExecutionScore />,
    getPreview: () => <ExecutionScore />
  },
  premiumPsychology: {
    type: 'premiumPsychology',
    defaultSize: 'medium',
    allowedSizes: ['medium'],
    category: 'other',
    getComponent: () => <PsychologyMonitor />,
    getPreview: () => <PsychologyMonitor />
  },
  premiumCalendar: {
    ...
    allowedSizes: ['large'],
    category: 'other',
    getComponent: () => <PremiumCalendar />,
    getPreview: () => <PremiumCalendar />
  },
  premiumQuickJournal: {
    type: 'premiumQuickJournal',
    defaultSize: 'small',
    allowedSizes: ['small', 'medium'],
    category: 'other',
    getComponent: () => <QuickJournalWidget />,
    getPreview: () => <QuickJournalWidget />
  },
  premiumSentiment: {
    type: 'premiumSentiment',
    defaultSize: 'small',
    allowedSizes: ['small'],
    category: 'other',
    getComponent: () => <MarketSentimentWidget />,
    getPreview: () => <MarketSentimentWidget />
  },
  premiumDailyDrawdown: {
    type: 'premiumDailyDrawdown',
    defaultSize: 'small',
    allowedSizes: ['small'],
    category: 'statistics',
    getComponent: () => <DailyDrawdown />,
    getPreview: () => <DailyDrawdown />
  }
  // marketChart: {
  //   type: 'marketChart',
  //   defaultSize: 'large',
